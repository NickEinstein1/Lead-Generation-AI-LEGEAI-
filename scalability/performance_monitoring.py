...
class PerformanceMonitor:
    ...
    async def _collect_application_metrics(self):
        ...
        try:
            # Queue metrics
            from scalability.distributed_processing import task_queue, worker_manager
        ...
        try:
            # Cache metrics
            from scalability.load_balancing import distributed_cache
        ...
        try:
            ...
            from scalability.load_balancing import api_load_balancer
