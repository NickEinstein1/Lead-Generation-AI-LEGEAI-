...
class Policy(Base, TimestampMixin):
    ...
    # Policy details
    policy_type: Mapped[str] = mapped_column(String(50), nullable=False, index=True)  # Auto, Home, Life, Health
    status: Mapped[str] = mapped_column(String(32), default="active", index=True)  # active, expired, cancelled
    premium: Mapped[str] = mapped_column(String(50), nullable=False)  # e.g., "$1,200/yr"
