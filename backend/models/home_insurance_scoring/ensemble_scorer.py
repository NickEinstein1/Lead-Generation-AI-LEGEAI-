"""
Ensemble Scorer for Home Insurance Leads
...
from backend.models.home_insurance_scoring.inference_deep_learning import HomeInsuranceDeepLearningScorer

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)


class EnsembleHomeInsuranceScorer:
    """
    Ensemble scorer combining XGBoost and Deep Learning for home insurance
    ...
    def _initialize_models(self):
        ...
        try:
            ...
            logger.info("XGBoost model loaded for home insurance ensemble")
        except Exception as e:
            logger.warning(f"Could not load XGBoost model: {e}")
        
        try:
            # Initialize Deep Learning scorer (home-specific)
            self.deep_learning_scorer = HomeInsuranceDeepLearningScorer()
            logger.info("Deep Learning model loaded for home insurance ensemble")
        except Exception as e:
    ...
    def score_lead(self, lead_data: Dict) -> Dict[str, Any]:
        """
        Score a home insurance lead using ensemble of models
