...
from backend.monitoring.performance_monitor import performance_monitor, MonitoredOperation
from backend.monitoring.alerting import AlertManager
from backend.monitoring.reporting import PerformanceReporter
...
async def record_custom_metric(request: MetricRequest):
    ...
    try:
        from backend.monitoring.performance_monitor import PerformanceMetric, MetricType
