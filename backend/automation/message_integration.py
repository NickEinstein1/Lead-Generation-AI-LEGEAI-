...
from backend.automation.workflow_engine import WorkflowEngine, TriggerType, ActionType, WorkflowAction, TriggerCondition
from backend.automation.notification_system import NotificationSystem, NotificationType, NotificationPriority
from backend.automation.task_management import TaskManager, TaskType, TaskPriority
...
class MessageAutomationIntegration:
    ...
    def _setup_message_templates(self):
        ...
        from backend.automation.notification_system import NotificationTemplate
