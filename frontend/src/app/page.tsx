  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-gradient-to-b from-[#f8fafc] via-[#f3f6fb] to-[#eef2f7]">
      ...
      <header className="px-6 py-4">
        <div className="mx-auto max-w-6xl flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            <Link href="#features" className="text-neutral-700 hover:text-primary">Features</Link>
            <Link href="#how-it-works" className="text-neutral-700 hover:text-primary">How it works</Link>
            <Link href="#pricing" className="text-neutral-700 hover:text-primary">Pricing</Link>
          </nav>
          <div className="flex items-center gap-3 text-sm">
            <Link href="/login" className="text-neutral-700 hover:text-primary">Login</Link>
            <Link href="/register" className="bg-primary text-white px-3 py-2 rounded">Get started</Link>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1">
        <section className="mx-auto max-w-6xl px-6 py-10 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-neutral-600 text-lg max-w-prose">
          ...
          <div className="rounded-xl border bg-white/70 backdrop-blur p-4 shadow-sm">
            <div className="text-sm text-neutral-500 mb-2">Live preview</div>
            <div className="aspect-video rounded border bg-gradient-to-br from-white to-neutral-50" />
            <ul className="mt-4 grid grid-cols-2 gap-3 text-sm">
              <li className="rounded border bg-white p-3">Real-time routing</li>
              <li className="rounded border bg-white p-3">ML scoring</li>
              <li className="rounded border bg-white p-3">Analytics</li>
              <li className="rounded border bg-white p-3">Role-based access</li>
            </ul>
          </div>
        </section>
      ...
      <footer className="border-t bg-white/60 backdrop-blur">
        <div className="mx-auto max-w-6xl px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-neutral-600">
