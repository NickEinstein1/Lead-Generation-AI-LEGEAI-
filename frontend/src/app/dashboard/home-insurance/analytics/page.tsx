...
export default function HomeInsuranceAnalyticsPage() {
  ...
  const propertyDistribution = buildDistribution(analytics?.property_type_distribution, {
    ...
    const htmlContent = `
      ...
      <body>
        ...
        <table>
          ...
          ${buildTableRows(analytics.property_type_distribution, {
            single_family: 'Single Family',
            multi_family: 'Multi-Family',
          })}
        </table>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white border-2 border-blue-200 rounded-lg p-6 shadow-lg">
            ...
            {propertyDistribution.length === 0 ? (
              <div className="text-sm text-slate-600 font-medium">No property distribution data.</div>
            ) : (
              <div className="space-y-3">
        ...
        <div className="mt-6">
          ...
          <AnalyticsCharts
            ...
            typeDistribution={propertyDistribution}
            trendData={trendData}
          />
        </div>
      </div>
