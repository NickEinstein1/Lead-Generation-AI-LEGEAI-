...
async def generate_social_media_message(request: Dict[str, Any]):
    ...
    """
    try:
        from models.message_generation.social_media_integration import SocialMediaMessageGenerator, SocialPlatform, InteractionType
...
async def send_personalized_email(request: Dict[str, Any]):
    ...
    """
    try:
        from models.message_generation.email_automation import EmailAutomationSystem
